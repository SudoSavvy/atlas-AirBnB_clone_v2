...
from flask import Flask, render_template  # Import Flask and render_template for HTML rendering
...
def number_is_integer(n):
    ...
    Args:
        n (int): A variable part of the URL that must be an integer.

    Returns:
        str: A string of the format "n is a number" if `n` is an integer.
    """
...
def number_template(n):
    ...
    Returns:
        HTML: An HTML page displaying "Number: n" within an <H1> tag, if `n` is an integer.
    """
