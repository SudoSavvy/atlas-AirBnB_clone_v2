...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, arg):
        ...
        obj_id = obj.id  # Store the ID for later checks
        if arg == "State":
            if hasattr(obj, 'name'):
                obj.name = kwargs.get('name', '')
        
        # Save the object to storage
        storage.new(obj)  # Assuming storage is your storage handler
        storage.save()     # Save changes to file.json
        print(obj_id)      # Print the ID of the new instance
